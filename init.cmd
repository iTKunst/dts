...
rem echo dts\init.cmd [ENTER]
  ...
  SET "CMD_SET_PATH=%DIR_BIN%%DIR_SLASH%mSET_PATH"
  rem ECHO CMD_SET_PATH is %CMD_SET_PATH% [VAR]
  CALL %CMD_SET_PATH%

  SET "CMD_BASE=%DIR_BASE%%DIR_SLASH%%FILE_INIT%"
  rem ECHO CMD_BASE is %CMD_BASE% [VAR]
  CALL %CMD_BASE%

  SET "UP=%DOT%%DOT%%DIR_SLASH%"
  SET "CMD_SRC=%UP%%UP%system%DIR_SLASH%%FILE_INIT%"
  rem ECHO CMD_SRC is %CMD_SRC% [VAR]
  CALL %CMD_SRC%
