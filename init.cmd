...
rem echo dts\init.cmd [ENTER]
  ...
  rem ECHO FILE_INIT is %FILE_INIT%
  ...
  rem ECHO CMD_BNDL is %CMD_BNDL%
  CALL %CMD_BNDL%

  SET "CMD_SET_PATH=%DIR_BIN%%DIR_SLASH%mSET_PATH"
  rem ECHO CMD_SET_PATH is %CMD_SET_PATH%
  CALL %CMD_SET_PATH%

  SET "CMD_BASE=%DIR_BASE%%DIR_SLASH%%FILE_INIT%"
  rem ECHO CMD_BASE is %CMD_BASE%
  CALL %CMD_BASE%

  SET "CMD_SRC=..%DIR_SLASH%..%DIR_SLASH%system%DIR_SLASH%%FILE_INIT%"
