...
log_env_enter gENV_PROJ
  ...
  log_env_var PROJ_DIR $PROJ_DIR
  export FILE_ENV_PROJ=$PROJ_DIR$DIR_SLASH$ENV_PROJ_FILE
  log_env_var FILE_ENV_PROJ $FILE_ENV_PROJ

  export FILE_ENV_SYS=$SYS_DIR$DIR_SLASH$ENV_SYS_FILE
  log_env_var FILE_ENV_SYS $FILE_ENV_SYS

  export FILE_ENV_TMPL=$TMPL_DIR$DIR_SLASH$ENV_TMPL_FILE
