...
log_env_enter gENV_TAGS
  ...
  export SOAP_CLNT_TAG=$SPLIT$SOAP$SPLIT$CLNT
  export SOAP_SRVR_TAG=$SPLIT$SOAP$SPLIT$SRVR
  ...
  export WSDL_CLNT_TAG=$SPLIT$WSDL$SPLIT$CLNT
  export WSDL_SRVR_TAG=$SPLIT$WSDL$SPLIT$SRVR
