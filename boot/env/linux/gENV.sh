...
# Automatically generated or default values
  ...
  export WSDL_CLNT_CONT=$SYS_CONT$WSDL_CLNT_TAG
  export WSDL_CLNT_CONT_DIR=$OPT_DIR$APP_DIR
  export WSDL_CLNT_HOST_DIR=
  export WSDL_CLNT_IMG=$SYS_IMG$WSDL_CLNT_TAG
  export WSDL_CLNT_PORT_INT=80
  export WSDL_CLNT_VOL=

  export WSDL_CLNT_CONT_MNT_DIR=$WSDL_CLNT_CONT_DIR$TRGT_DIR
  export WSDL_CLNT_HOST_MNT_DIR=$WSDL_CLNT_HOST_DIR$TRGT_DIR
