...
SET "DIR_CERT=%USR_DIR%%LOCAL_DIR%%SHARE_DIR%%CA_CERT_DIR%"
 echo DIR_CERT is %DIR_CERT%

SET "DIR_WP_CONTENT=%WP_DIR%%DASH%%CONTENT%"
 echo DIR_WP_CONTENT is %DIR_WP_CONTENT%

SET "DIR_DCKR=%DIR_TMPL_CURR%%DCKR_DIR%"
 echo DIR_DCKR is %DIR_DCKR%
