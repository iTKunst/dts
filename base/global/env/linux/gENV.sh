...
export ANS_CONT_MNT_DIR=
export ANS_HOST_DATA_DIR=
...
export DCKR_URI=$TEMPLATE_DIR$DCKR_DIR$FOR_SLASH$DCKR_FILE
...
export JAVA_CONT_DIR=$USR_DIR$SRC_DIR$APP_DIR
export JAVA_HOST_DIR=$CODE_DIR
export JAVA_IMG=$SYS_IMG$JAVA_TAG
export JAVA_PORT_INT=8080
export JAVA_VOL=

export JAVA_CONT_MNT_DIR=$JAVA_CONT_DIR$TRGT_DIR
export JAVA_HOST_MNT_DIR=$JAVA_HOST_DIR$TRGT_DIR
...
export NANO_CONT_MNT_DIR=
export NANO_HOST_MNT_DIR=
...
export NODE_CONT_MNT_DIR=$NODE_CONT_DIR
export NODE_HOST_MNT_DIR=$NODE_HOST_DIR
